 ...
 *
 */
public class FollowerEncounter extends AbstractEncounter {
	 ...
	 * @param e
	 */
	public FollowerEncounter(Encounter e) {
		super(e);
	}
	
	public FollowerEncounter(String string) throws WrongFormatException {
		super(string);
	}
	
	static Logger logger = Logger.getLogger(FollowerEncounter.class);
	 ...
	 * @param parseLine
	 */
	private void handleLine(GeneralEncounterDataContainer obsDataBean, String[] parseLine) {
	...
	/**
	 * @see org.openmrs.module.mastercard.entities.AbstractEncounter#getCsvSerialized()
	 */
	@Override
